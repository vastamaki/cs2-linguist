...
export interface ChatSettings {
  ...
  log_path: string; threads: number; position: Settings['position'];
}
export const defaultChatSettings: ChatSettings = { enabled: false, model: 'm2m100-418m', language: 'auto', log_path: '', threads: 2, position: null };
export interface Settings {
  voice_enabled: boolean; overlays_enabled: boolean; chat: ChatSettings;
...
export interface TranslationHistory { revision: number; voice: Caption[]; chat: ChatCaption[] }
